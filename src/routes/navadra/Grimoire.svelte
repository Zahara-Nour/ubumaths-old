...
<div class="fond l70 mh1 h70">
    ...
    <div id="elements_grimoire" class="ib l80">
        <img id="feu" class="md4" title="" src="/images/navadra/elements/feu.png"/>
        <img id="eau" class="md4" title="" src="/images/navadra/elements/eau.png"/>
        <img id="vent" class="md4" title="" src="/images/navadra/elements/vent.png"/>
        <img id="terre" title="" src="/images/navadra/elements/terre.png"/>
    </div>

    {#each ["feu", "eau", "vent", "terre"] as element}

    <div id={`sorts_${element}`} class="ib l80 mh1">

        {#each sorts[element] as sort}
       
          {@const caracs = sort.carac_sort}
		...
		<div id="upgradeSpells" class="ib l80 mh1">
			...
			<div class="ib l12">
    		<img id={`upgradeSpell${i}`} class="l80 learnableSpells" src="/images/navadra/spells/feu_1.png"/>
    ...
    <div id="validate_learning" class="div_centrale mh05">
      ...
      <a href="#"><img class="icone_form_droite" src="/images/navadra/icones/play.png"></a>
    </div>

    <!-- Return button -->
    <a class="gris" href="#"><div id="reinitialiser_sort" class="bouton form_gauche">Réinitialiser</div></a>
    <a href="#"><img class="icone_form_gauche" src="/images/navadra/icones/btn_reinitialiser.png"></a>
