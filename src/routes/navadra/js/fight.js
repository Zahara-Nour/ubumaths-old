...
// We start from TURNS_IN_A_ROUND to 0 (at 0 means 1 monster attacks and a new round starts
let remaining_turn = TURNS_IN_A_ROUND;
// Time in seconds to let the player choose a spell
let COUNTDOWN_CHOOSE_SPELL = 20;
